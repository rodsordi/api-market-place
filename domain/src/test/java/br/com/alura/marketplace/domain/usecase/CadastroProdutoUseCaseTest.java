...
class CadastroProdutoUseCaseTest {
    ...
    class Cadastrar {
        ...
        class Sucesso {
            ...
            void beforeEach() {
                when(produtoRepository.save(any()))
                        .thenAnswer(invocationOnMock -> {
                            Produto produto = invocationOnMock.getArgument(0);
                            setField(produto, "produtoId", UUID.fromString("fe68b7c4-b05e-4800-90c2-1ccbe564473b"));
                            return produto;
                        });
            }
            ...
            void teste1() {
                ...
                assertThat(atual.getProdutoId())
                        .isEqualTo(UUID.fromString("fe68b7c4-b05e-4800-90c2-1ccbe564473b"));
            }
        ...
        class Falha {
            ...
            @DisplayName("Dado um produto com o nome que comça com -")
            @Test
            void teste1() {
                // Dado
                var produto = criarProduto()
                ...
                // Então
                assertThat(atual)
                        .hasMessage("O nome não pode começar com -");
            }
        }
    }
}